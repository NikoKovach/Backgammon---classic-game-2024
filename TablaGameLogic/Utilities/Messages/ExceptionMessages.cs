namespace TablaGameLogic.Utilities.Messages
{
     public static class ExceptionMessages
     {
          ...
          public const string InvalidGameBoard = "The {0} cannot be null !";

          public const string InvalidPlayersCollection = 
                                   "The players collection cannot be null !";

          public const string InvalidColor = 
                                   "You must select \"White\" or \"Black\" color.";

          public const string InvalidBoardParameter = 
                                   "The input parameter {0} cannot be null !";

          public const string InvalidMoveConfirmationParameter = 
                                   "The input value for {0} cannot be null !";

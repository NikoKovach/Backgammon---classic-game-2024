namespace TablaModels.ComponentModels
{
    ...
    {
        private const int OneSideBoardWidth = 270;  // maxOneSideBoardWidth = DefaultOneSideBoardWidth *2
        ...
        { 
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("The board width must be in range  12 - 540 units!");
                }

                if (value % 6 > 0)
                {
                    throw new ArgumentException("The width must be divisible by 6 without a remainder !");
                }

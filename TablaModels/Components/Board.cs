namespace TablaModels.Components
{
     ...
     public class Board : IBoard
     {
          ...
          public Board(IDictionary<int, IColumn> columns, IDictionary<int, IDice> dice,
          ...
          private void CheckInnerParameters(IDictionary<int, IColumn> columns,
               IDictionary<int, IDice> dice, 
               IList<IPool> whitePools, IList<IPool> blackPools)
          {
               if (columns == null)
               {
                   throw new ArgumentNullException(
                        string.Format(ExceptionMessages.BoardArgumentNullException,
                        nameof(columns)));
               };
